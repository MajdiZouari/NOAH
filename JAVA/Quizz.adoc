...
-----------------
"Write Once, Run Evrywhere" est le moto de Java. En fait, l'indépendance du système consiste à développer le même code quel que soit la plateforme sur laquelle il tourne.
----------------- 
 *  What is bytecode?
-----------------
